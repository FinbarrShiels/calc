...
const StepsCalculator: React.FC<StepsCalculatorProps> = ({ calculator }) => {
  // Unit state
  ...
  // Calculate steps per mile based on height or stride length
  useEffect(() => {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 dark:bg-card rounded-lg shadow-md p-6">
      ...
      <h2 className="calculator-section-header">How Many Steps in a Mile Calculator</h2>
