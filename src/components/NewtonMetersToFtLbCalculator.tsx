    ...
    <div className={inputClasses}>
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="calculator-card-alt rounded-lg shadow-xl overflow-hidden">
          <div className="p-6">
            <h2 className={calculatorSectionHeaderClasses}>Newton Meters to Foot Pounds Calculator</h2>
            ...
            <div className="calculator-card-alt p-6 rounded-lg shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                  <div className={resultLabelClasses}>Newton Meters</div>
                ...
                <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
                  <div className={resultLabelClasses}>Foot Pounds</div>
