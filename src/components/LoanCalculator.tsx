...
const LoanCalculator = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 w-full">
      ...
      <div className="w-full lg:w-2/5 bg-gray-900 text-white p-4 sm:p-6 rounded-lg">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-6 gap-1">
            <button 
              className={`py-2 px-2 sm:px-4 rounded text-sm sm:text-base ${currency === '$' ? 'bg-orange-500' : 'bg-gray-700 hover:bg-gray-600'}`}
              onClick={() => setCurrency('$')}
            >
              $
            </button>
            ...
            <button 
              className={`py-2 px-2 sm:px-4 rounded bg-gray-700 hover:bg-gray-600`}
            >
              ...
            </button>
          </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex">
            <span className="bg-gray-700 py-2 px-4 rounded-l">{currency}</span>
            <input
              type="tel"
              value={loanAmountStr}
              onChange={(e) => handleNumberInput(e.target.value, setLoanAmountStr)}
              className="w-full bg-gray-700 text-white py-2 px-4 rounded-r focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="25000"
              {...decimalInputProps}
            />
          </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex">
            <input
              ...
              onChange={(e) => handleNumberInput(e.target.value, setInterestRateStr)}
              className="w-full bg-gray-700 text-white py-2 px-4 rounded-l focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="4.5"
              {...decimalInputProps}
            />
            <span className="bg-gray-700 py-2 px-4 rounded-r">%</span>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-700 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="5"
                {...numericInputProps}
              />
            </div>
            <div>
              ...
              <input
                type="tel"
                value={monthsStr}
                onChange={(e) => handleNumberInput(e.target.value, setMonthsStr)}
                className="w-full bg-gray-700 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="0"
                {...numericInputProps}
              />
        ...
        <div className="mb-6">
          <label className="block mb-2">Additional Payment (Optional):</label>
          <div className="flex">
            <span className="bg-gray-700 py-2 px-4 rounded-l">{currency}</span>
            <input
              onChange={(e) => handleNumberInput(e.target.value, setAdditionalPaymentStr)} 
              {...decimalInputProps}
              className="w-full bg-gray-700 text-white py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="0"
            />
            <select
              value={additionalPaymentFrequency}
              onChange={(e) => setAdditionalPaymentFrequency(e.target.value)}
              className="bg-gray-700 text-white py-2 px-4 rounded-r focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
        ...
        <div className="mb-6">
          <label className="block mb-2">One-Time Payment (Optional):</label>
          <div className="flex mb-2">
            <span className="bg-gray-700 py-2 px-4 rounded-l">{currency}</span>
            <input
              onChange={(e) => handleNumberInput(e.target.value, setOneTimePaymentStr)} 
              {...decimalInputProps}
              className="w-full bg-gray-700 text-white py-2 px-4 rounded-r focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="0"
            />
          ...
          <div className="grid grid-cols-2 gap-2">
            <select
              ...
              className="bg-gray-700 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
      ...
      {/* Right side - Results */}
      <div className="w-full lg:w-3/5 bg-gray-900 text-white p-4 sm:p-6 rounded-lg">
        ...
        {viewMode === 'summary' && (
          <div className="bg-gray-800 p-6 rounded-lg">
            <p className="text-gray-400 mb-4">Summary of your loan:</p>
