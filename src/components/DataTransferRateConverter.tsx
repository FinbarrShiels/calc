...
const DataTransferRateConverter: React.FC<DataTransferRateConverterProps> = ({ calculator }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden">
      <div className="p-6">
        <h2 className={calculatorSectionHeaderClasses}>Data Transfer Rate Converter</h2>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
              <div className={resultLabelClasses}>Input Value</div>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
              <div className={resultLabelClasses}>Converted Value</div>
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
          <h3 className={calculatorSectionHeaderClasses}>Common Data Transfer Rates</h3>
